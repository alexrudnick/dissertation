...
historically the native language of the Guarani people. The word for the
language in Guarani is \emph{avañe'e} (``people's language", where
\emph{ñe'e} means ``language").
