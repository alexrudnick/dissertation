...
model for Spanish would prefer sentences about things in enclosures than things in writing implements.
...
translated as \emph{etape} in French;
...
Chinese, whereas English speakers typically distinguish ``pop" and ``break"
\cite{majid2007semantic}.
...
with their common objects maybe learned and stored in the phrase table, and the
language model will encourage common collocations as well. However
longer-distance relationships can still cause strange translations in practice.
