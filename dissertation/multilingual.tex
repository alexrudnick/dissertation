...
of Lefever \emph{et al.} and our earlier SemEval entry, to get our stacking
features, we trained classifiers mapping from Spanish to Dutch, English, French
German and Italian, based on both the Europarl corpus and our available Bible
translations.

All classifiers used for the Spanish-Guarani and Spanish-Quechua tasks in this
section were trained with the baseline features described in
Chapter~\ref{chap:baseline}, as well as the new features introduced in this
chapter; these are presented in Figure~\ref{fig:stackingfeatures}.
We also trained classifiers with the addition of the syntactic features
described in Chapter~\ref{chap:monolingual}.
