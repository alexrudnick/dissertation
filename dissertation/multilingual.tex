...
Using the automatic tools distributed with the Europarl corpus distribution, we
produced sentence-aligned bitext, ending up with roughly 1.7 sentence pairs 

%% XXX what else to say about Europarl?
%% XXX probably talk about how many sentence pairs we end up with?
%% XXX also how the parallel sentence extraction happens, what scripts get
%% used, how they're distributed with the corpus...
