...
abundance of bitext, although unfortunately not between Spanish and Guaran√ or
Quechua.
This bitext does allow us to learn translations between our source language and
some other languages, however.
When this works well, we can correctly infer the meaning of a word in context in
the resource-rich source language, at least implicitly, in as far as we are able
to select the correct translation for a word or phrase in a resource-rich target
language.
