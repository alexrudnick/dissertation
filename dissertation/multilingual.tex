...
As we have been discussing, while our target languages are under-resourced, we
have many resources for our source languages.
Notably for Spanish, we have a relative abundance of bitext that pairs Spanish
with other resource-rich languages; many other languages have a similar
situation.
We would like to be able to learn from these bitext corpora when translating
into our under-resourced target languages.
