...
with other languages, especially other resource-rich languages.
We would like to be able to learn from these other bitext corpora when
translating from resource-rich source languages into under-resourced target
languages.
...
So we would like our system to be able to learn relationships between the
senses of a given source word that are lexicalized in different ways in
different languages.  Two target languages may happen to surface similar sense
distinctions, perhaps due to being related languages, or simply by coincidence.
