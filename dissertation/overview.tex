...
RBMT systems with statistical methods where possible, making use both of the
efforts and insights of linguists working on MT, and of machine learning.
%% XXX this could use some work; more explanation of what we mean by hybrid
...
used, and there will be many thousands of words that might need to be
translated in any given source language.
