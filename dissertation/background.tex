...
%% XXX maybe include an OED entry for some super-polysemous word
...
unsupervised word-sense induction approaches...
...
In the early history of machine translation,
translate sentences with simple ambiguities like \emph{The box was in the pen.}
\cite{barhillel1960}:
