...
their respective senses from WordNet
\cite{DBLP:journals/cacm/Miller95} (the English-language wordnet from
Princeton).
The version distributed currently it features XXX sentences, each manually
annotated, and it was used for the XXX SensEval shared task.
