...
\begin{figure*}
  ...
  \begin{tabulary}{\textwidth}{|R|L|}
    \hline
    Total verses with changes & 41 (out of 100) \\
    \hline
    Number of changes judged to be improvements &  XXX \\
    \hline
    Number of changes judged to be worse &  XXX \\
    \hline
    Number of changes judged to be neutral or unclear &  XXX \\
    \hline
  \end{tabulary}
  \end{centering}
