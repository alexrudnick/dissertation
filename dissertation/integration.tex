...
\item A baseline phrase-based SMT system made with Moses
\cite{koehn-EtAl:2007:PosterDemo}.
...
%% Not relevant to the argument; don't do this.
...
Figures XXX and XXX show summarized results of these first two experiments.
