...
\ref{fig:some-spanish-verses-with-changes}. We see when translating Sentence
\ref{sent:alreadydead}  from Spanish to
...
is the communicative sense, rather than the naming sense. In Sentence \
