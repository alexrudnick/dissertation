...
proofs of concept, rather than production-ready code, but they demonstrate at
least conceptually how CL-WSD can be used with these translation systems.
...
to guide the decoding process while it is constructing translations.
