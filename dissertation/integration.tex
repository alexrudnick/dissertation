...
to llama the animal, which is a loan word from Quechua.}, which seems strange,
since this should be caught by part-of-speech tagging. In any case, without
SQUOIA, we choose an inflection of \emph{waqya}, which is the 'call out' sense
of \emph{llamar}, and with Chipa, we choose an inflection of \emph{suti}, the
'naming' sense. Neither of these are correct.
