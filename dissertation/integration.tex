...
%% XXX write about how we can't we just annotate the phrase table for
%individual % sentences just before decoding -- we need to know about the
%phrase *in a % context* and that's the point.
