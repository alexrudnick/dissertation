...
In this chapter, we discuss how the Chipa software, along with its extensions
...
Subsequently, we look at evaluating Chipa's effect on MT output, translating
from Spanish into Guarani with a simple statistical MT system, and from Spanish
to Quechua with a rule-based MT system.
