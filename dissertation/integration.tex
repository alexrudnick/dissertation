...
other ways to use the output of the Chipa classifiers, such as removing lexical
choices with low scores.
...
%% XXX: number of sentences/verses for all these things, make a little table.
