...
that word. These annotations give a more abstract, less sparse representation
than surface forms or lemmas, hopefully providing useful semantic and syntactic
generalizations.
...
used in Chapter \ref{chap:baseline}, simply with different or additional
features; notably we tried using the neural embedding features on their own.
