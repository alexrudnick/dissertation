...
names of many countries, some nouns referring to people by profession, and some
semantically similar verbs. The words listed in these figures are the top
twenty terms from that cluster, by frequency. Note that the names given for the
clusters were also chosen by hand, rather than through some automatic process.
We can see that the clustering process is finding some satisfying
...
words fit well together as singular feminine nouns, which is more of a
...
nouns" cluster in Figure \ref{fig:clusters-wikipedia-surface}, we see nouns that
refer to people's professions, although it should also be noted that these are
all singular masculine nouns.

In the Wikipedia clusters, we see some satisfying clusters as well; many
adjectives describing political positions cluster together, as do verbs
describing making a choice (Figure \ref{clusters-wikipedia-lemma})
