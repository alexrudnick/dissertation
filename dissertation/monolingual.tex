...
%% XXX: turn this into a nice figure rather than doing it inline; this is not
%% typesetting well.
...
extract features
\texttt{brown\_window\_wikipedia\_lemma(111110111111111110)},
\texttt{brown\_window\_wikipedia\_lemma\_4(1111)},
\texttt{brown\_window\_wikipedia\_lemma\_6(111110)} and 
\texttt{brown\_window\_wikipedia\_lemma\_10(1111101111)}, setting them all to
1. We additionally can extract analogous features for all the tokens in the
sentence; these would be called \texttt{brown\_bag\_wikipedia\_lemma}. If we
are using clusters based on the surface forms, these simply do not have
\texttt{lemma} in their name, and features based on Europarl, are marked with
\texttt{europarl} rather than \texttt{wikipedia}.
