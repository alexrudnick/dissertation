...
%% XXX: for each of these subsections, make a little chart comparing the best
%% results with the baselines (for each of the four settings):
%% - MFS baseline
%% - default features baseline from previous chapter
%% Then for the end, show the best ones from each subsection, all together.
...
\begin{figure*}
  ...
  \begin{tabulary}{\textwidth}{|R|L|L|L|L|}
    ...
    \hline
    +pos tags features, maxent l1 & XXX & XXX & XXX & XXX \\
    \hline
    +all syntactic features, maxent l1 & XXX & XXX & XXX & XXX \\
    \hline
...
\begin{figure*}
  ...
  \begin{tabulary}{\textwidth}{|R|L|L|L|L|}
    ...
    classifier & es-gn regular & es-gn non-null & es-qu regular & es-qu non-null \\
    \hline
    Wikipedia clusters, lemmatized, maxent l1 & XXX & XXX & XXX & XXX \\
    \hline
    Europarl clusters, lemmatized, maxent l1 & XXX & XXX & XXX & XXX \\
    \hline
    Wikipedia clusters, surface, maxent l1 & XXX & XXX & XXX & XXX \\
    \hline
    Europarl clusters, surface, maxent l1 & XXX & XXX & XXX & XXX \\
    \hline
    Wikipedia clusters, surface, window only, maxent l1 & XXX & XXX & XXX & XXX \\
    \hline
    MFS    & 0.456 & 0.498 & 0.435 & 0.391 \\
    \hline
    best, baseline features & 0.481 & 0.524 & 0.464 & 0.431 \\
