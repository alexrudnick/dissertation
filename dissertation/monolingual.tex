...
left to future work, either by this author or other researchers. First we will
describe the methods used in some detail, and then towards the end of the
chapter, in Section \ref{sec:monolingual-experiments}, we describe experiments
...
formula in Figure XXX.

%% XXX: turn this into a nice figure with a nice caption
