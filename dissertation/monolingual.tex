...
\begin{itemize}
  ...
  from both europarl and wikipedia, and both skipgram and cbow, in full
  sentence, window, and pyramid combination approaches.
  \item doc2vec embeddings trained on wikipedia: full sentence
  \item doc2vec embeddings trained on wikipedia: window sentence
\end{itemize}
