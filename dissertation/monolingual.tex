...
\begin{itemize}
  ...
  syntactic features and Brown clusters (context window, surface form,
  Wikipedia).
\end{itemize}
...
(explained in Figure \ref{fig:brownfeatures}) in Figure \ref{fig:brownresults}.
...
MFS baseline. This seems to be too many potentially-irrelevant features,
perhaps overwhelming the useful signals present in the baseline feature set.

However, we get better results when we limit the Brown cluster features to a
narrow context words of three words on either side of the focus word; this
seems to lead to roughly the same results for the maximum entropy classifiers
-- except for the ``non-null" case for L2-norm for Spanish-Quechua, as in the
results for syntactic features in Figure \ref{fig:syntactic-results}. But for
the random forest classifiers, we see consistent gains of three to six tenths
of a percentage point. So for random forest classifiers, it seems worthwhile to
add these window-based Brown cluster features.
...
{\small
  ...
  \begin{tabulary}{\textwidth}{|R|L|L|L|L|}
    ...
    \hline
    \hline
    \multicolumn{5}{|l|}{maxent l1 (200 dims)} \\
    \hline
window, mwes, europarl & 0.460 & 0.504 & 0.447 & 0.416 \\
    \hline
window, mwes, wikipedia & 0.467 & 0.511 & 0.450 & 0.422 \\
    \hline
window, europarl & 0.462 & 0.506 & 0.447 & 0.417 \\
    \hline
window, wikipedia & 0.468 & 0.511 & 0.451 & 0.423 \\
    \hline
pyramid, mwes, europarl & 0.462 & 0.505 & 0.447 & 0.418 \\
    \hline
pyramid, mwes, wikipedia & 0.469 & 0.512 & 0.452 & 0.423 \\
    \hline
pyramid, europarl & 0.463 & 0.507 & 0.448 & 0.418 \\
    \hline
pyramid, wikipedia & 0.469 & 0.512 & 0.453 & 0.424 \\
    \hline
fullsent, mwes, europarl & 0.421 & 0.465 & -     & -     \\
    \hline
fullsent, mwes, wikipedia & 0.428 & 0.469 & -     & -     \\
    \hline
...
fullsent, wikipedia & 0.428 & 0.468 & 0.408 & 0.374 \\
    ...
    \multicolumn{5}{|l|}{maxent l2 (200 dims)} \\
    \hline
window, mwes, europarl & 0.453 & 0.500 & 0.439 & 0.413 \\
    \hline
window, mwes, wikipedia & 0.461 & 0.506 & 0.445 & 0.420 \\
    \hline
window, europarl & 0.455 & 0.501 & 0.440 & 0.414 \\
    \hline
window, wikipedia & 0.461 & 0.507 & 0.445 & 0.420 \\
    \hline
pyramid, mwes, europarl & 0.457 & 0.504 & 0.443 & 0.418 \\
    \hline
pyramid, mwes, wikipedia & 0.464 & 0.511 & 0.449 & 0.423 \\
    \hline
pyramid, europarl & 0.459 & 0.505 & 0.443 & 0.417 \\
    \hline
pyramid, wikipedia & 0.465 & 0.512 & 0.449 & 0.424 \\
    \hline
fullsent, mwes, europarl & 0.421 & 0.469 & -     & -     \\
    \hline
fullsent, mwes, wikipedia & 0.427 & 0.472 & -     & -     \\
    \hline
...
fullsent, wikipedia & 0.427 & 0.472 & 0.408 & 0.379 \\
    ...
    \multicolumn{5}{|l|}{random forest} \\
    \hline
window, mwes, europarl & 0.448 & 0.489 & -     & -     \\
    \hline
window, mwes, wikipedia & 0.451 & 0.493 & -     & -     \\
    \hline
window, europarl & 0.447 & 0.491 & -     & -     \\
    \hline
window, wikipedia & 0.453 & 0.494 & -     & -     \\
    \hline
fullsent, mwes, europarl & 0.431 & 0.474 & -     & -     \\
    \hline
fullsent, mwes, wikipedia & 0.433 & 0.476 & -     & -     \\
    \hline
...
embeddings, although we tried several different embeddings sizes.}
...
{\small
  ...
  \begin{tabulary}{\textwidth}{|R|L|L|L|L|}
    ...
    \multicolumn{5}{|l|}{maxent l1} \\
    \hline
window, mwes, europarl & 0.411 & 0.454 & -     & -     \\
    \hline
...
pyramid, wikipedia & -     & -     & 0.401 & 0.375 \\
    \hline
fullsent, mwes, europarl & 0.388 & 0.434 & -     & -     \\
    \hline
fullsent, mwes, wikipedia & 0.391 & 0.433 & -     & -     \\
    \hline
...
fullsent, wikipedia & 0.391 & 0.433 & -     & -     \\
    ...
    \multicolumn{5}{|l|}{maxent l2} \\
    \hline
window, mwes, europarl & 0.402 & 0.447 & -     & -     \\
    \hline
window, mwes, wikipedia & 0.406 & 0.451 & -     & -     \\
    \hline
...
pyramid, wikipedia & -     & -     & 0.398 & 0.377 \\
    \hline
fullsent, mwes, europarl & 0.392 & 0.441 & -     & -     \\
    \hline
fullsent, mwes, wikipedia & 0.394 & 0.441 & -     & -     \\
    \hline
...
fullsent, mwes, europarl & 0.431 & 0.474 & -     & -     \\
    \hline
fullsent, mwes, wikipedia & 0.434 & 0.478 & -     & -     \\
    \hline
...
window, mwes, europarl & 0.448 & 0.489 & -     & -     \\
    \hline
window, mwes, wikipedia & 0.451 & 0.494 & -     & -     \\
    \hline
