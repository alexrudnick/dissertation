...
\ref{fig:enesresults:monolingual}, we see the results for the Chipa system with
roughly the same classifiers used in Chapter \ref{chap:baseline}, but now with
the features based on our monolingual resources described in this chapter,
first on Spanish-Guaraní. As before, we report classification accuracy as a
percentage, and we performed ten-fold cross-validation, using all of the
...
%% XXX: add the Quechua results once those are ready
