...
suite \cite{padro12} on input sentences. FreeLing can perform a number of
analysis tasks for Spanish, including POS tagging, dependency parsing,
lemmatization, and named entity recognition, of which the latter two are part
of the standard preprocessing done for all experiments in this work. When all
