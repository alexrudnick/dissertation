...
Taking a look at the scores from the features based on extant Spanish-language
NLP tools, we see that we were able to surpass the MFS baseline with the
dependency-parse and POS-tag-based features. They seemed to work especially
well with the L2-norm maxent classifier and random forests.
