...
In either case, the result of word2vec is a static mapping from word types to
their embeddings in a vector space of a given size, typically a few hundred
dimensions.
...
come up, but the embeddings for individual words provide  a useful
generalization.
