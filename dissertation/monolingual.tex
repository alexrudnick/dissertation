...
Finding a globally optimal assignment for this turns out to be a
computationally difficult problem, but several greedy approaches that find
local optima have been explored in the literature.
Notably, in addition to Liang's approach, Franz Och's \texttt{mkcls} package
(described in \cite{och1999efficient}), has been distributed with Moses for
many years, and optimizes the same function.
