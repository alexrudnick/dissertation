...
\begin{itemize}
  ...
  \item Europarl Brown clusters (context window only), with baseline features
  \item Wikipedia Brown clusters (context window only), with baseline features
...
%% XXX ... that was kind of a lot of combinations
