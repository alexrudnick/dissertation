...
(with a few hundred dimensions, typically), as opposed to the high-dimensional
and sparse vectors typically used in earlier NLP literature.
...
We trained a variety of doc2vec embeddings for our text classification tasks,
