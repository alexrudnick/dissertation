...
setting, but probably more experimentation would be needed.
...
set. All of these approaches make more abstract representations of the source
text available to our classifiers, whether these representations were learned
from the available text, or encapsulate some kind of syntactic knowledge about
the language.
...
they do not perform as well when given dense vectors, like those produced by
word2vec and doc2vec; contrastingly, the maximum entropy classifiers
(especially with L1 regularization) have better performance in this setting.
