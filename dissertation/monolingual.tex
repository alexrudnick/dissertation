...
\begin{figure*}
  ...
  \begin{tabulary}{\textwidth}{|R|L|L|L|L|}
    ...
    \hline
    +Europarl clusters, surface, window only & 0.460 & 0.505 & 0.444 & 0.415 \\
    \hline
    +Europarl clusters, lemmatized, window only & 0.460 & 0.506 & 0.444 & 0.415 \\
    \hline
    +Wikipedia clusters, surface, window only & 0.460 & 0.506 & 0.445 & 0.416 \\
    \hline
    +Wikipedia clusters, lemmatized, window only & 0.460 & 0.506 & 0.443 & 0.415 \\
    \hline
    \hline
    ...
    \hline
    +Europarl clusters, surface, window only & 0.476 & 0.525 & 0.458 & 0.435 \\
    \hline
    +Europarl clusters, lemmatized, window only & 0.475 & 0.525 & 0.459 & 0.435 \\
    \hline
    +Wikipedia clusters, surface, window only & 0.475 & 0.525 & 0.460 & 0.436 \\
    \hline
    +Wikipedia clusters, lemmatized, window only & 0.475 & 0.524 & 0.459 & 0.434 \\
    \hline
    \hline
    ...
    \hline
    \hline
    +Europarl clusters, surface, window only & 0.483 & 0.524 & 0.466 & 0.430 \\
    \hline
    +Europarl clusters, lemmatized, window only & 0.483 & 0.524 & 0.466 & 0.428 \\
    \hline
    +Wikipedia clusters, surface, window only & 0.484 & 0.524 & 0.468 & 0.430 \\
    \hline
    +Wikipedia clusters, lemmatized, window only & 0.483 & 0.524 & 0.466 & 0.427 \\
    \hline
    \hline
  \end{tabulary}
  \end{centering}
