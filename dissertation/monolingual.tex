...
available during feature extraction. We can also show the gensim software the
context window around the focus word, rather than the entire sentence, to
generate a more focused representation.

In either case, the result is a vector of the chosen dimensionality ...
