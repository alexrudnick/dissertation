...
In this chapter, I describe the tasks and data sets that we will investigate for
the rest of the dissertation, as well as the basic version of the Chipa
software, which will be extended in a variety of directions in the following
chapters.
...
setting. The test sets for such WSD evaluations include sentences that were
...
necessarily lead to performance gains in the broader NLP system making use of
the proposed WSD technique.
%% XXX citation about this: maybe from the WSD special issue?
