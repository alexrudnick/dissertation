...
additionally ran the baseline Chipa system on the SemEval CL-WSD test sets from
2010 and 2013. No particular additional effort was made to tune the system for
these tasks, although the Chipa system is derived from the system we built for
the 2013 task.
