...
different; furthermore, we don't want to overfit our corpus by tuning
parameters too much after running tests. Here we will keep the default
regulaization setting of $C=1.0$.
...
the Spanish and Quechua text not being close translations of one another -- it
...
from Spanish into two under-resourced languages; in subsequent chapters, we
will see how to build on this baseline approach.
...
pipeline already handles these languages, and the results across languages were
...
The scores for the baseline Chipa system, as well as some other our systems
...
well, scoring better than all but three of the posted systems in the one-best
