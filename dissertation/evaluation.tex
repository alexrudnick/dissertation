...
\begin{itemize}
  \item 
  %% TODO: examples from Lamentations 1:2 in Quechua go here
  Quechua
Llapan munaqninkunamanta manan hukllapas kanchu sonqochay- kuqnin.
Llapan reqsinakuq-masinkunapas manan rikuqpas tukupunkuchu, llapallanmi awqanman tukupunku.

llapan munaqninkunamanta ma/mana huk/huklla ka/kanchu sonqochay - kuqnin .
  llapan reqsinakuq - masi ma/mana ri/riku tukupu , llapallanmi awqa tukupu .
  \item TODO: pick out nice Guarani example too.
\end{itemize}
\caption{Examples of morphological ambiguity in Quechua and Guarani, after
having run AntiMorfo and ParaMorfo.}
