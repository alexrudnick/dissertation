...
We can use the FreeLing analysis tools for Spanish, ... %% XXX(cite FreeLing)
which provides tokenization, sentence splitting, multi-word expression and
named entity detection, part-of-speech tagging and parsing. We start out with a
few of these functions at a basic level, and can add in more in Chapter
\ref{chap:monolingual}, making use of the quality NLP tools that we have for
Spanish in our multilingual task.
...
common phenomenon. The FreeLing analysis tools can resolve these ambiguities
for us...
%% XXX
