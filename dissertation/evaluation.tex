...
To get a sense about the difficulty of the classification task faced by a
classifier addressing these ambiguities, we can take a look at the number of
bits of entropy for some of the most common Spanish word types; this is shown
in Figure \ref{fig:mostcommon-es-entropy}. Here one bit of entropy corresponds
between a choice between two a priori equally likely options. Two bits of
entropy corresponds to choosing between four equally likely options, and so on.
