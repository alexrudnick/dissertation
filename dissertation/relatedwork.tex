...
classifiers consider input sentences as sets of words. %%XXX

Žabokrtsk\'{y} et al. \cite{vzabokrtsky-popel-marevcek:2010:WMT} take a similar
approach, using discriminative MaxEnt models to adapt the ``forward"
translation model probabilities in an SMT system based on dependency grammar.
...
%% XXX
This approach does not use one classifier
