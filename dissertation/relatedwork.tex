...
benefits from whatever techniques Google Translate is using to do word choice,
which are not necessarily discussed with the public, and these will change
